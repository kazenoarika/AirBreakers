...
#define DX_PS_CONSTF_SHADOW1_ENABLE_2_3_4_5     19		// シャドウマップ１用の情報( xyzw:ライト２～５への適用情報 )
#define DX_PS_CONSTF_SHADOW2_DADJ_GRAD_ENBL0_1  20		// シャドウマップ２用の情報( x:閾値深度補正値  y:グラデーション範囲  zw:ライト０・１への適用情報)
#define DX_PS_CONSTF_SHADOW2_ENABLE_2_3_4_5     21		// シャドウマップ２用の情報( xyzw:ライト２～５への適用情報 )
