...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x313e
#define DXLIB_VERSION_STR _T( "3.13e" )
		...
		//#pragma comment( lib, "winmm.lib"		)				//  マルチメディアライブラリ
			...
			//#pragma comment( lib, "msacm32.lib" )				// ＡＣＭ操作用ライブラリ 
				...
				#pragma comment( lib, "libbulletmath.lib" )
					...
					#ifdef _WIN64
						#ifdef _DEBUG
							#pragma comment( lib, "libtiff_vc12_x64_d.lib" )	// ＴＩＦＦライブラリ
						#else
							#pragma comment( lib, "libtiff_vc12_x64.lib" )		// ＴＩＦＦライブラリ
						#endif
					#else
						#ifdef _DEBUG
							#pragma comment( lib, "libtiff_vc12_d.lib" )		// ＴＩＦＦライブラリ
						#else
							#pragma comment( lib, "libtiff_vc12.lib" )			// ＴＩＦＦライブラリ
						#endif
					#endif
				#else
					#ifdef _WIN64
...
// キー定義
#define KEY_INPUT_BACK								D_DIK_BACK			// BackSpaceキー
#define KEY_INPUT_TAB								D_DIK_TAB			// Tabキー
#define KEY_INPUT_RETURN							D_DIK_RETURN		// Enterキー

#define KEY_INPUT_LSHIFT							D_DIK_LSHIFT		// 左Shiftキー
#define KEY_INPUT_RSHIFT							D_DIK_RSHIFT		// 右Shiftキー
#define KEY_INPUT_LCONTROL							D_DIK_LCONTROL		// 左Ctrlキー
#define KEY_INPUT_RCONTROL							D_DIK_RCONTROL		// 右Ctrlキー
#define KEY_INPUT_ESCAPE							D_DIK_ESCAPE		// Escキー
#define KEY_INPUT_SPACE								D_DIK_SPACE			// スペースキー
#define KEY_INPUT_PGUP								D_DIK_PGUP			// PageUpキー
#define KEY_INPUT_PGDN								D_DIK_PGDN			// PageDownキー
#define KEY_INPUT_END								D_DIK_END			// Endキー
#define KEY_INPUT_HOME								D_DIK_HOME			// Homeキー
...
#define KEY_INPUT_INSERT							D_DIK_INSERT		// Insertキー
#define KEY_INPUT_DELETE							D_DIK_DELETE		// Deleteキー
...
#define KEY_INPUT_LALT								D_DIK_LALT			// 左Altキー
#define KEY_INPUT_RALT								D_DIK_RALT			// 右Altキー
...
#define KEY_INPUT_LWIN								D_DIK_LWIN			// 左Winキー
#define KEY_INPUT_RWIN								D_DIK_RWIN			// 右Winキー

#define KEY_INPUT_NUMLOCK							D_DIK_NUMLOCK		// テンキーNumLockキー
...
extern	int			DeleteShaderConstantBuffer(		int SConstBufHandle ) ;																		// シェーダー用定数バッファハンドルの後始末
