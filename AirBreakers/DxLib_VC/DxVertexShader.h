...
#define DX_VS_CONSTF_SHADOWMAP1_LIGHT_VIEW_MAT         44			// シャドウマップ１用のライトビュー行列
#define DX_VS_CONSTF_SHADOWMAP1_LIGHT_PROJECTION_MAT   47			// シャドウマップ１用のライト射影行列
#define DX_VS_CONSTF_SHADOWMAP2_LIGHT_VIEW_MAT         51			// シャドウマップ２用のライトビュー行列
#define DX_VS_CONSTF_SHADOWMAP2_LIGHT_PROJECTION_MAT   54			// シャドウマップ２用のライト射影行列
